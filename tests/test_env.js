...
console.log("DEV_ALGOINDEXER_PORT = " + process.env.DEV_ALGOINDEXER_PORT)
...
console.log("TESTNET_ALGOINDEXER_SERVER = " + process.env.TESTNET_ALGOINDEXER_SERVER)
...
console.log("MAINNET_ALGOINDEXER_SERVER = " + process.env.MAINNET_ALGOINDEXER_SERVER)
